...
if __name__ == "__main__":
    ...
    ##### INITIAL SCREEN PATHS #####
    REPURPOSING_DATASET_ROOT_DIR = '/DataSets/DrugRepurposing/InitialScreen/'
    ...
    # repurposing_feat_df, repurposing_metadata = read_hydra_metadata(repurposing_feat_file, repurpossing_fname_file, METADATA_PATH)
